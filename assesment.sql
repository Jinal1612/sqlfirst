...
select country_name_eng , customer_name from country left join city on country.id = city.country_id left join customer on city.id = customer.city_id;
...
select country_name_eng, city_name, customer_name from country join city on country.id = city.country_id join customer on city.id = customer.city_id; 
 
-- Return even countries without related cities and customers.
select country_name from country left join city on country.id = city.country_id left join customer on city.id = customer.city_id where city_name is  null;
...
select country_name , customer_name from country left join city on country.id = city.country_id inner join customer on city.id = customer.city_id;

-- Return even pairs of not having a single customer
select country_name,  customer_name from country left join city on country.id = city.country_id right join customer on city.id = customer.city_id;
